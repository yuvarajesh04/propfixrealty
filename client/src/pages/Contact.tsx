  ...
  return (
    <section className="contact-section p-3">
      ...
      <div className="row g-4 d-flex justify-content-between align-items-start flex-lg-row flex-column">
        ...
        <div className="col-lg-6 col-md-12 d-flex align-items-stretch justify-content-center">
          <div className="contact-card">
            <div className="card-header rounded text-center mb-3">
              <h5 style={{ textDecoration: "underline", textDecorationColor: "linear-gradient(135deg, #4f79ac, #08aef5)" }}>
                Send Us a Message
              </h5>
            </div>
            <div className="card-body">
              <form method="POST" onSubmit={handleSubmit}>
                ...
                <button type="submit" className="submit-btn w-100" disabled={isSubmitting}>
                ...
                {formStatus && formStatus.show && (
                  <div
                    className={`alert alert-${formStatus.type} mt-3 mb-0 text-center`}
                    role="alert"
        ...
        {/* Company Info */}
        <div className="col-lg-6 col-md-12 d-flex align-items-stretch justify-content-center">
          <div className="contact-card h-100 p-3" style={{
            background: "#ffffff",
            borderRadius: "12px",
            ...
            <div className="card-body d-flex flex-column justify-content-center">
              <p className="mb-2"><strong>Address:</strong> F2 block, No. 308, Ozone Greens, Phase II Perumbakkam, Jalladianpet Road</p>
              <p className="mb-2"><strong>Phone:</strong> <a href="tel:+919789360885">+91 9789360885</a></p>
              <p className="mb-2"><strong>Email:</strong> <a href="mailto:arunkumar@propfixrealty.com">arunkumar@propfixrealty.com</a></p>
