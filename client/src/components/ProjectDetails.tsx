...
export default function ProjectDetails() {
  ...
  return (
    <>
      <Helmet>
        <title>
          {`${project.title} - ${project.type} in ${project.location} | Propfix Realty`}
        </title>
        <meta
          name="description"
          content={`Buy DTCP approved ${project.type} at ${project.title}, ${project.location}. Best price, ready-to-build residential units in Chennai. Book your site visit now!`}
        />
        <link
          rel="canonical"
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              image: project.images?.map(
                (imgUrl: string) => `https://propfixrealty.com${imgUrl}`
              ),
              address: {
                "@type": "PostalAddress",
              ...
              mainEntity: [
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: `Yes, ${project.title} plots in ${project.location} are fully DTCP approved with clear titles.`,
                  },
                },
                {
                  "@type": "Question",
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: `The starting price of plots in ${project.title}, ${project.location} is ₹${project.price} onwards.`,
                  },
                },
                {
                  "@type": "Question",
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: `${project.title} is located in ${project.location}, Chennai with excellent connectivity to schools, highways, and IT hubs.`,
                  },
                },
                {
                  "@type": "Question",
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: `${project.location} is one of Chennai's fastest developing areas with upcoming infrastructure projects, making it a great choice for real estate investment.`,
                  },
                },
              ],
            }),
              ...
              {project.images?.map((imgUrl: string, idx: number) => (
                <Carousel.Item key={idx}>
                  <img
                    ...
                    alt={`Plots in ${project.location} - ${project.title} - Image ${
                      idx + 1
                    }`}
                  />
                </Carousel.Item>
        ...
        <div className="faq-section p-3">
          ...
          <Accordion>
            <Accordion.Item eventKey="0">
              <Accordion.Header>
                Is {project.title} DTCP approved?
              </Accordion.Header>
              <Accordion.Body>
                Yes, {project.title} plots in {project.location} are fully DTCP
                approved with clear titles.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="1">
              <Accordion.Header>
                What is the starting price of plots in {project.title}?
              </Accordion.Header>
              <Accordion.Body>
                The starting price of plots in {project.title},{" "}
                {project.location} is ₹{project.price} onwards.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="2">
              <Accordion.Header>Where is {project.title} located?</Accordion.Header>
              <Accordion.Body>
                {project.title} is located in {project.location}, Chennai with
                excellent connectivity to schools, highways, and IT hubs.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="3">
              <Accordion.Header>
                Why should I invest in plots at {project.location}?
              </Accordion.Header>
              <Accordion.Body>
                {project.location} is one of Chennai's fastest developing areas
                with upcoming infrastructure projects, making it a great choice
